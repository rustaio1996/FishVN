const appTranslations = {
  vi: {
    ...
    "event.gio_bao_thu.desc": "Tốc độ câu +30%, Nghiệp lực +50%, tăng x3 cơ hội gặp Cá Đột Biến và Thủy Quái (21h-22h hàng ngày).",
    "event.dem_khuya_mi_tom.name": "🍜 Đêm Khuya Húp Mì Tôm",
    "event.dem_khuya_mi_tom.desc": "EXP câu cá +50%, giá bán cá giảm 10% do ngủ gật (0h-2h hàng ngày).",
    "event.thu_sau_13.name": "💀 Thứ Sáu Ngày 13",
    "event.thu_sau_13.desc": "Kiếp nạn thứ 83! Tỷ lệ gặp cá phẩm chất Kiếp Nạn tăng 200%, sét đánh giảm 30% vàng hiện có.",
  ...
  en: {
    ...
    "event.gio_bao_thu.desc": "Reel speed +30%, Karma +50%, and Mutant/Leviathan encounter rates x3 (9 PM - 10 PM daily).",
    "event.dem_khuya_mi_tom.name": "🍜 Midnight Noodle Craving",
    "event.dem_khuya_mi_tom.desc": "EXP +50% but sell price -10% due to sleepiness (Midnight - 2 AM daily).",
    "event.thu_sau_13.name": "💀 Friday the 13th",
    "event.thu_sau_13.desc": "Calamity 83rd! Calamity fish encounter rates +200%, lightning strikes deduct 30% of current gold.",
