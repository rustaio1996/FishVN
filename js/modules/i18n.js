const appTranslations = {
  vi: {
    ...
    "name.desc":
      "Chào mừng cần thủ đến với vùng biển bất ổn! Hãy khai báo danh tính bựa nhất của bạn để bắt đầu hành trình và đặt tên cho file lưu game:",
    ...
    "timeEvents.empty":
      "Không có sự kiện nào... Thời buổi bình thường như bao giờ.",
    ...
    "subtab.gearcrafting": "🛠️ Chế Đồ",
    "quest.title": "🧾 NHIỆM VỤ NGÀY & THỬ THÁCH",
    "quest.desc":
      "Hoàn thành nhiệm vụ hôm nay để nhận vàng, mồi may mắn và buff hài hước.",
    "quest.footer":
      "Mỗi ngày reset lúc 0h. Nhớ quay lại để nhận phần thưởng nhé!",
    "ui.collapse": "Thu gọn",
    "ui.expand": "Mở rộng",
    ...
    "event.thu7_ca_ngua.desc":
      "Cá tự bơi vào lưới! Thời gian chờ -70%, May mắn x2, Vàng +50%.",
    "event.thu2_the_tham.name": "😩 Thứ Hai Thê Thảm",
    "event.thu2_the_tham.desc":
      "Đầu tuần nghiệp chướng nặng! Karma tăng x2, cá rác xuất hiện nhiều hơn.",
    "event.chu_nhat_chill.name": "😎 Chủ Nhật Chill",
    "event.chu_nhat_chill.desc":
      "Nghỉ ngơi cuối tuần, giá bán cá +40%, EXP +50%.",
    "event.sang_som.name": "🌅 Câu Sáng Sớm",
    "event.sang_som.desc":
      "Cá chưa tỉnh giấc dễ bắt! EXP x2.0 trong giờ vàng 5h-7h.",
    "event.gio_ngu_trua.name": "😴 Giờ Ngủ Trưa Bất Ổn",
    "event.gio_ngu_trua.desc":
      "Cá cũng ngủ nướng! Chờ lâu hơn (+50%) nhưng cá hiếm xuất hiện nhiều hơn (May mắn x1.5).",
    "event.cu_dem.name": "🦩 Ngư Ông Cú Đêm",
    "event.cu_dem.desc":
      "Đêm khuya huyền bí! Tỷ lệ ra cá Huyền Thoại và Tối Cao tăng mạnh (May mắn x1.8).",
    "event.ngay_luong.name": "💰 Ngày Lãnh Lương",
    "event.ngay_luong.desc":
      "Mồng 1 mỗi tháng! Tài lộc tràn đến, giá bán tất cả cá x2!",
    "event.ngay_13.name": "💀 Ngày 13 Đen Tối",
    "event.ngay_13.desc":
      "Ngày xui xẻo! Sét đánh tăng, karma tích nhanh hơn x1.5.",
    "event.gio_bao_thu.name": "⚡ Giờ Báo Thủ Điên Cuồng",
    "event.gio_bao_thu.desc":
      "Tốc độ câu +30%, Nghiệp lực +50%, tăng x3 cơ hội gặp Cá Đột Biến và Thủy Quái (21h-22h hàng ngày).",
    "event.dem_khuya_mi_tom.name": "🍜 Đêm Khuya Húp Mì Tôm",
    "event.dem_khuya_mi_tom.desc":
      "EXP câu cá +50%, giá bán cá giảm 10% do ngủ gật (0h-2h hàng ngày).",
    "event.thu_sau_13.name": "💀 Thứ Sáu Ngày 13",
    "event.thu_sau_13.desc":
      "Kiếp nạn thứ 83! Tỷ lệ gặp cá phẩm chất Kiếp Nạn tăng 200%, sét đánh giảm 30% vàng hiện có.",
    ...
    "minigame.desc":
      "Bỏ 30đ vào cược, chọn 1 trong 3 rương thần bí. Thắng gói về vàng, mồi may mắn, hoặc item bá đạo!",
    "minigame.rules_label": "Quy tắc:",
    "minigame.rules_body":
      "30đ / lượt. Phần thưởng có thể là: 60-100đ, 1 mồi may mắn, 1 bình giảm nghiệp, hoặc 1 lọ ớt tốc độ.",
  ...
  en: {
    ...
    "name.desc":
      "Welcome to the unhinged waters! Declare your finest fisher name to start the journey and name your save file:",
    ...
    "subtab.help": "❓ Help",
    "subtab.zone": "🗺️ Map",
    "subtab.gearcrafting": "🛠️ Gear Crafting",
    "quest.title": "🧾 DAILY QUESTS & CHALLENGES",
    "quest.desc":
      "Complete today's quests to earn gold, lucky bait, and funny buffs.",
    ...
    "event.thu7_ca_ngua.desc":
      "Fish swim straight into nets! Wait time -70%, Luck x2, Gold +50%.",
    "event.thu2_the_tham.name": "😩 Terrible Monday",
    "event.thu2_the_tham.desc":
      "Heavy bad karma at start of week! Karma rate x2, more trash appears.",
    "event.chu_nhat_chill.name": "😎 Chill Sunday",
    "event.chu_nhat_chill.desc":
      "Weekend rest, fish sell price +40%, EXP +50%.",
    "event.sang_som.name": "🌅 Early Morning Fishing",
    "event.sang_som.desc":
      "Fish haven't woken up yet! EXP x2.0 during golden hours 5am-7am.",
    "event.gio_ngu_trua.name": "😴 Unstable Nap Time",
    "event.gio_ngu_trua.desc":
      "Fish are sleeping in! Wait longer (+50%) but find more rare fish (Luck x1.5).",
    "event.cu_dem.name": "🦩 Night Owl Fisher",
    "event.cu_dem.desc":
      "Mystical late hours! Mythical & Supreme catch rates boosted (Luck x1.8).",
    "event.ngay_luong.name": "💰 Payday",
    "event.ngay_luong.desc":
      "1st day of the month! Abundant fortune, all fish sell price x2!",
    "event.ngay_13.name": "💀 Dark 13th",
    "event.ngay_13.desc":
      "Unlucky day! Lightning strikes are common, karma accumulates 1.5x faster.",
    "event.gio_bao_thu.name": "⚡ Unhinged Rush Hour",
    "event.gio_bao_thu.desc":
      "Reel speed +30%, Karma +50%, and Mutant/Leviathan encounter rates x3 (9 PM - 10 PM daily).",
    "event.dem_khuya_mi_tom.name": "🍜 Midnight Noodle Craving",
    "event.dem_khuya_mi_tom.desc":
      "EXP +50% but sell price -10% due to sleepiness (Midnight - 2 AM daily).",
    "event.thu_sau_13.name": "💀 Friday the 13th",
    "event.thu_sau_13.desc":
      "Calamity 83rd! Calamity fish encounter rates +200%, lightning strikes deduct 30% of current gold.",
    ...
    "minigame.desc":
      "Bet 30g and pick 1 of 3 mysterious chests. Win gold, lucky bait, or unhinged items!",
    "minigame.rules_label": "Rules:",
    "minigame.rules_body":
      "30g per turn. Prizes: 60-100g, 1 lucky bait, 1 karma reducer, or 1 speed potion.",
